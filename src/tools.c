/* This is a direct import of Z.Yang's tools.c from his PAML 
   package.
   --Jason Stajich 2004
*/
...
double PAMLIncompleteGamma (double x, double alpha, double ln_gamma_alpha)
{
...
l4:
   q=ch;   p1=.5*ch;
   if ((t=PAMLIncompleteGamma (p1, xx, g))<0)
      error2 ("\nIncompleteGamma");
   p2=p-t;
...
*/
   ...
   if (median) {
      ...
      for (i=0; i<K-1; i++)
         freqK[i]=PAMLIncompleteGamma(freqK[i]*beta, alpha+1, lnga1);
      rK[0] = freqK[0]*factor;
